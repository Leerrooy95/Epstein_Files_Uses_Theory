...
*Last updated: February 10, 2026 (v9.1) — Updated README.md and Report.md to v8.6. Annotated Three-Layer Model ghost data (Layers 2-3 retracted). Fixed broken links to archived Repository_Synthesis.md. Added AI Fabrication Case Study to navigation. Trimmed oldest changelog section.*
