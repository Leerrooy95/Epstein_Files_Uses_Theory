...
├── TikTok_Algorithm_Anomaly_Investigation.md ← Feb 12 investigation of TikTok search/algorithm anomalies around Oracle takeover (Jan 22-Feb 2026). 7 verified anomalies, 50+ sources, UVB-76 methodology applied.
...
*Last updated: February 12, 2026 (v9.9) — Created TikTok_Algorithm_Anomaly_Investigation.md (Oracle takeover window Jan–Feb 2026: 7 verified anomalies, search bar glitches, FYP collapse, Epstein DM blocking, mass migration to UpScrolled, CA investigation, 50+ sources). Updated folder structure.*
